package com.personal.liumn.customview;
...
public class MyViewTest extends View
{
    ...
    private void init(AttributeSet attrs, int defStyle)
    {
        ...
        mExampleString = a.getString(R.styleable.MyViewTest_exampleString);
        mExampleColor = a.getColor(R.styleable.MyViewTest_exampleColor, mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(R.styleable.MyViewTest_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.MyViewTest_exampleDrawable))
        {
            mExampleDrawable = a.getDrawable(R.styleable.MyViewTest_exampleDrawable);
